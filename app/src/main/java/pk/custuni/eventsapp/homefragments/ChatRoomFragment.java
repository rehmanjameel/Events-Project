...
import pk.custuni.eventsapp.adapter.ChatInvitationAdapter;
import pk.custuni.eventsapp.databinding.FragmentChatRoomBinding;
import pk.custuni.eventsapp.model.NotificationsModel;
                        ...
                        for (QueryDocumentSnapshot snapshot :
                            ...
                            if (snapshot != null) {
                                ...
                                if (!isStatus) {
                                    ...
                                    Log.e("notifications get data21", title + " .,." + postId);
