package pk.custuni.eventsapp.homefragments;
...
import pk.custuni.eventsapp.activities.CreateEventActivity;
import pk.custuni.eventsapp.activities.ProfileActivity;
import pk.custuni.eventsapp.adapter.HomeEventsAdapter;
import pk.custuni.eventsapp.databinding.FragmentHomeBinding;
import pk.custuni.eventsapp.model.HomeEventsModel;
import pk.custuni.eventsapp.services.DeleteExpiredEventsWorker;
...
public class HomeFragment extends Fragment {
    ...
    public void onResume() {
        ...
        LocalBroadcastManager.getInstance(requireActivity()).registerReceiver(postDeletedReceiver, new IntentFilter("pk.custuni.eventsapp.ACTION_POST_DELETED"));
